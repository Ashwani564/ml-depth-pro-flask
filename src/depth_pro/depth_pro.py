...
# --- MODIFICATION: Make the model path robust ---
# This code finds the root of the project and builds an absolute path to the model
_current_dir = os.path.dirname(os.path.abspath(__file__))
_project_root = os.path.dirname(os.path.dirname(_current_dir))
_model_uri = os.path.join(_project_root, "models/depth_pro.pt")

DEFAULT_MONODEPTH_CONFIG_DICT = DepthProConfig(
    patch_encoder_preset="dinov2l16_384",
    image_encoder_preset="dinov2l16_384",
    checkpoint_uri=_model_uri,  # <-- USE THE CORRECT, DYNAMICALLY CREATED PATH
